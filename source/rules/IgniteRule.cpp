...
IgniteRule::IgniteRule(bool allowBurn) : Rule(std::string("ignition:")+(allowBurn?"burn":"")), allowBurn(allowBurn) {}

void IgniteRule::Execute(Forest* forest, Cell self) {
...
bool IgniteRule::CanExecute(Cell self) {
